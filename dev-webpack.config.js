...
const GUID = 'charticulatorVisualCommunity_EDITOR_DEV' || pbivizFile.visual.guid;
const NAME = 'CharticulatorCommunityVersionEditor' || pbivizFile.visual.name;
const DISPLAY_NAME = 'Charticulator Community Version (Editor) DEV' || pbivizFile.visual.displayName;
